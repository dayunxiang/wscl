...
import com.tmxk.wscl.android.mvp.model.TableWaterUpByYear;
...
public class WaterUpByYearActivity extends MvpActivity<WaterAnalysisPresenter> implements SewageArchiveView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water_up_year);
    ...
    public void getDataSuccess(Object object, DataTypeEnum dataTypeEnum) {
        if (object instanceof AreaListBean) {
            Log.d("WaterUpByYearActivity", "AreaListBean " + object.toString());
            ...
            regionView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Log.d("WaterUpByYearActivity", "onItemClick " + position);
                    Log.d("WaterUpByYearActivity", "onItemClick-regions " + regions.get(position));
                    flag = true;
        ...
        }  else if (object instanceof WaterUpYearBean) {
            WaterUpYearBean waterUpYearBean = (WaterUpYearBean) object;
            Log.d("WaterUpByYearActivity", "WaterUpYearBean " + object.toString());
            Log.d("WaterUpByYearActivity", "WaterUpYearBean.size " + waterUpYearBean.getObject().size());
            if (waterUpYearBean != null && waterUpYearBean.getObject().size() > 0) {
                Log.d("WaterUpByYearActivity", "size>0");
                int sortNum = 0;
                List<TableWaterUpByYear> tableWaterUpList = new ArrayList<>();
                for (WaterUpYearBean.ObjectBean w : waterUpYearBean.getObject()) {
                    //初始化数据TableWaterUp
                    if(w!=null){
                        TableWaterUpByYear t = new TableWaterUpByYear();
