...
import com.tmxk.wscl.android.adpter.WaterTestListAdapter;
 ...
 * user manage page
 */
public class WaterTestManagerActivity extends MvpActivity<OperatePresenter> implements SewageArchiveView {
    private int SEWAGE_ID;
    private WaterTestListAdapter waterTestListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                ...
                if (SEWAGE_ID != 0) {
                    mvpPresenter.getWaterTestManagerByCondition(true, SEWAGE_ID, start, end);
                } else {
                    mvpPresenter.getWaterTestManagerByCondition(true, start, end);
                }
        ...
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                ...
                if (SEWAGE_ID != 0) {
                    mvpPresenter.getWaterTestManagerByCondition(false, SEWAGE_ID, start, end);
                } else {
                    mvpPresenter.getWaterTestManagerByCondition(false, start, end);
                }
...
//        });
    ...
    public void getDataSuccess(Object object, DataTypeEnum dataTypeEnum) {
        if (object instanceof WaterTestListBean) {
            if (waterTestListAdapter != null) {
                List<WaterTestListBean.ObjectBean> waterTestBeans = waterTestListAdapter.getList();
                waterTestBeans.addAll(((WaterTestListBean) object).getObject());
                waterTestListAdapter.setList(waterTestBeans);
                waterTestListAdapter.notifyDataSetChanged();
            } else {
                waterTestListAdapter = new WaterTestListAdapter(this, ((WaterTestListBean) object).getObject());
                listView.setAdapter(waterTestListAdapter);
            }
