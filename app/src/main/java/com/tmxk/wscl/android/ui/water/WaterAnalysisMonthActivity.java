...
public class WaterAnalysisMonthActivity extends MvpActivity<WaterAnalysisPresenter> implements SewageArchiveView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water_month);
    ...
    public void getDataSuccess(Object object, DataTypeEnum dataTypeEnum) {
        if (object instanceof AreaListBean) {
            Log.d("WaterAnalysisActivity", "AreaListBean " + object.toString());
            ...
            regionView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Log.d("WaterAnalysisActivity", "onItemClick " + position);
                    Log.d("WaterAnalysisActivity", "onItemClick-regions " + regions.get(position));
            ...
            Log.d("WaterAnalysisActivity", "SewageListBean " + object.toString());
...
//                mDropDownMenu.setDropDownMenu(Arrays.asList(headers), popupViews, contentView);
        ...
        }else if(object instanceof WaterAnalysisMonthBean){
            WaterAnalysisMonthBean waterAnalysisMonthBean = (WaterAnalysisMonthBean) object;
            Log.d("WaterAnalysisActivity", "WaterAnalysisMonthBean " + object.toString());
...
//                  Date startDate = CommonUtil.String2Date(btnDeviceSetupDate.getText().toString().concat(".000"));
                    ...
                    if(sewageId>0){
                        mvpPresenter.getWaterAnalysisMonth(btnCheckDate.getText().toString().substring(0,7),sewageId);
                    }else{
                        toastShow("请选择站点");
                    }
                }else{
