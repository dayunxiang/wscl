...
public class AssignmentOrderListBean {
    ...
    public static class ObjectBean {
         ...
         * taskType : type
         * taskDate : 1554832656000
         * taskDescription : desc
         * beginTaskTime : 1554868656000
         * endTaskTime : 1554904656000
         * taskStatus : 已完成
         * equipno : null
         */
        ...
        public SewageBean getSewage() {
            return sewage;
        }

        public void setSewage(SewageBean sewage) {
            this.sewage = sewage;
        }
        ...
        public Long getBeginTaskTime() {
            return beginTaskTime;
        }

        public void setBeginTaskTime(Long beginTaskTime) {
            this.beginTaskTime = beginTaskTime;
        }
        ...
        public static class SewageBean {
            /**
             * id : 23
             ...
             * name : 锡北泾西长浜河
             * address : null
             * coordinateX : 41.963177
             * coordinateY : 116.400246
             * equipment1state : 1
             * equipment2state : 2
             * equipment3state : 1
             * equipment4state : 2
